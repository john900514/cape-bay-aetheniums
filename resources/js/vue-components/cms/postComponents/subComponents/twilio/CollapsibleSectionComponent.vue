...
<div class="col-md-12 section-container">
    ...
    <div class="col-md-12" :class="'section'+sectionNo">
        <div class="form-section col-md-12 row">
            ...
            <div class="form-group col-sm-12" v-for="(data, idx) in subSections">
...
<script>
import CollapsibleSubSection from "./CollaspibleSubSectionComponent";
    ...
    methods: {
        ...
        removeSubSection(idx) {
            ...
            if(idx in this.subSections) {
                ...
                console.log(this.subSections[idx])
            }
            else {
