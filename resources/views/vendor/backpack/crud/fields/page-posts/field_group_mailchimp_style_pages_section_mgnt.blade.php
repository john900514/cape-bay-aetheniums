...
@push('crud_fields_scripts')
    ...
    <script src="{{ asset('https://amchorcms-assets.s3.amazonaws.com/backpack_packages/ckeditor/ckeditor.js') }}"></script>
    <script src="{{ asset('https://amchorcms-assets.s3.amazonaws.com/backpack_packages/ckeditor/adapters/jquery.js') }}"></script>
@endpush
