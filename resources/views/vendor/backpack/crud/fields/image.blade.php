...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        <link href="{{ asset('https://amchorcms-assets.s3.amazonaws.com/backpack_packages/cropperjs/dist/cropper.min.css') }}" rel="stylesheet" type="text/css" />
        <style>
            .image .btn-group {
                margin-top: 10px;
            }
    ...
    @push('crud_fields_scripts')
        <script src="{{ asset('https://amchorcms-assets.s3.amazonaws.com/backpack_packages/cropperjs/dist/cropper.min.js') }}"></script>
        <script src="{{ asset('https://amchorcms-assets.s3.amazonaws.com/backpack_packages/jquery-cropper/dist/jquery-cropper.min.js') }}"></script>
        <script>
