 ...
 @endphp
  ...
  {{-- DATA TABLES SCRIPT --}}
  <script type="text/javascript" src="https://amchorcms-assets.s3.amazonaws.com/backpack_packages/datatables.net/js/jquery.dataTables.min.js"></script>
  <script type="text/javascript" src="https://amchorcms-assets.s3.amazonaws.com/backpack_packages/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
  <script type="text/javascript" src="https://amchorcms-assets.s3.amazonaws.com/backpack_packages/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
  <script type="text/javascript" src="https://amchorcms-assets.s3.amazonaws.com/backpack_packages/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js"></script>
  <script type="text/javascript" src="https://amchorcms-assets.s3.amazonaws.com/backpack_packages/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js"></script>
  <script type="text/javascript" src="https://amchorcms-assets.s3.amazonaws.com/backpack_packages/datatables.net-fixedheader-bs4/js/fixedHeader.bootstrap4.min.js"></script>
      ...
      dataTableConfiguration: {
        ...
        */
        ...
        language: {
              ...
              "processing":     "<img src='{{ asset('js/backpack/crud/img/ajax-loader.gif') }}' alt='{{ trans('backpack::crud.processing') }}'>",
              "search": "_INPUT_",
