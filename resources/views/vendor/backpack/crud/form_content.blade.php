...
@section('after_styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/backpack/crud/css/'.$action.'.css').'?v='.config('backpack.base.cachebusting_string') }}">
...
@section('after_scripts')
    ...
    <script src="{{ asset('js/backpack/crud/js/'.$action.'.js').'?v='.config('backpack.base.cachebusting_string') }}"></script>
